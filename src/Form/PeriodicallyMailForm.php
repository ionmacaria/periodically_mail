...
/**
 * @file
 * Contains \Drupal\periodically_mail\Form\PeriodicallyMailForm.
 */
...
class PeriodicallyMailForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['periodically_mail_user_type'] = array(
      '#type' => 'select',
    ...
    $form['periodically_mail_periode'] = array(
      '#type' => 'select',
    ...
    $form['periodically_mail_started_from'] = array(
      '#type' => 'datetime',
    ...
    $form['periodically_mail_email_title'] = array(
      '#type' => 'textfield',
      '#title' => t('Email Title'),
    ...
    $form['periodically_mail_email'] = array(
      '#type' => 'text_format',
      '#title' => t('Email'),
